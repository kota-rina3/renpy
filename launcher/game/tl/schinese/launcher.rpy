translate schinese strings:
    ...
    new "使用您在 Ren'Py 之外安装的 Visual Studio Code 副本。建议安装 language-renpy 扩展来增加对 Ren'Py 文件的支持。"
    ...
    new "无法使用 javac 编译测试文件。若尚未安装 Java 开发工具包，请从以下位置下载：\n\n{a=https://adoptium.net}https://adoptium.net/{/a}\n\nJDK 与 JRE 不同，有 Java 但没 JDK 的话。请安装 JDK [JDK_REQUIREMENT] ，并将其添加到您的 PATH 中。\n\n没有可用的 JDK 的话是无法继续的"
    ...
    new "Atom 文本编辑器已弃坑。建议使用 Visual Studio Code 或其他编辑器。"
